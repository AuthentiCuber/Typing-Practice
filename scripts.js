...
let timer;
let wordIndex = 0;
let wordsToType = "hello there my very good friend hello there my very good friend hello there my very good friend";
let currentWord;
let prevWord;
...
const startTest = (event) => {
   ...
   typing.setAttribute("onkeydown", "setTimeout(() => {handleTyping(event)}, 1)");
};
...
const finishTest = () => {
   ...
   rawWPM = (parseInt(correctCharsTyped) / AVERAGE_WORD_LENGTH) * (ONE_MINUTE / typingTimeSeconds);
